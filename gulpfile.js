...
gulp.task('script', function () {
	return gulp.src('src/js/parts/*.js').pipe(concat('main.js')).pipe(gulp.dest('src/js'));
});
...
gulp.task('watch', function () {
	...
	gulp.watch('src/js/parts/*.js', gulp.parallel('script'));
...
gulp.task('default', gulp.parallel('html', 'server', 'styles', 'script', 'watch'));
